...
export function PriceHistory() {
    const priceData = [
        { name: 'Jan 2023', price: 60 },
        { name: 'Fev 2023', price: 60 },
        { name: 'Mar 2023', price: 48 },
        { name: 'Abr 2023', price: 60 },
        { name: 'Mai 2023', price: 60 },
        { name: 'Jun 2023', price: 30 },
        { name: 'Jul 2023', price: 36 },
        { name: 'Ago 2023', price: 60 },
        { name: 'Set 2023', price: 60 },
        { name: 'Out 2023', price: 40 },
        { name: 'Nov 2023', price: 15 },
        { name: 'Dez 2023', price: 24 },
    ];
        ...
        <div className={`${styles['graphic']}`}>
            <div className={`${styles['data-graphic']}`}>
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Tooltip 
                            contentStyle={{ backgroundColor: '#1A1D27', borderColor: '#2D3243', borderRadius: '8px', color: '#fff' }}
            ...
            <div className={`${styles['status-graphic']}`}>
                ...
                <div className={`${styles['status']} ${styles['average']}`}>
                    <p><PiWaveTriangleBold className={`${styles['icon']} ${styles['icon-average']}`}/>PREÇO MÉDIO</p>
                    <p className={`${styles['price']}`}>R$49.90</p>
                    <p>Todas Lojas - 12 meses</p>
                </div>
                <div className={`${styles['status']} ${styles['versus']}`}>
                    <p><FaArrowsUpDown className={`${styles['icon']} ${styles['icon-versus']}`}/>ATUAL vs MÍNIMO</p>
                    <p className={`${styles['discount']}`}>+60%</p>
                    <p>R$23.99 vs mínimo histórico</p>
                </div>
            </div>       
        </div>
    );
